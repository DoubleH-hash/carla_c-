...
"""autogenerated by genpy from ys_ros_msgs/LaneDetectionArray.msg. Do not edit."""
import codecs
import sys
...
class LaneDetectionArray(genpy.Message):
  _md5sum = "c93a62e7777b4d80f9bf607c90c25a61"
  _type = "ys_ros_msgs/LaneDetectionArray"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','ys_ros_msgs/LaneDetection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ys_ros_msgs.msg.LaneDetection()
        start = end
        end += 1
