...
"""autogenerated by genpy from ys_ros_msgs/AprilTagDetection.msg. Do not edit."""
import codecs
import sys
...
class AprilTagDetection(genpy.Message):
  _md5sum = "2c09a74bc79c22ff38a6979274d39267"
  _type = "ys_ros_msgs/AprilTagDetection"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string family
int32 id
...
float64 w
"""
  __slots__ = ['family','id','center','corners','pose']
  _slot_types = ['string','int32','geometry_msgs/Point','geometry_msgs/Point[4]','geometry_msgs/PoseWithCovarianceStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.corners is None:
        self.corners = [geometry_msgs.msg.Point() for _ in range(4)]
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_i3d().pack(_x.id, _x.center.x, _x.center.y, _x.center.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.family = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.family = str[start:end]
      _x = self
      start = end
      end += 28
      (_x.id, _x.center.x, _x.center.y, _x.center.z,) = _get_struct_i3d().unpack(str[start:end])
      self.corners = []
      for i in range(0, 4):
