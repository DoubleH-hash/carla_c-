...
"""autogenerated by genpy from ys_ros_msgs/Map.msg. Do not edit."""
import codecs
import sys
...
class Map(genpy.Message):
  _md5sum = "c3d491eef4a21986c927049c6c1329f8"
  _type = "ys_ros_msgs/Map"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32 lane_num
Lane[] lanes
...
string frame_id
"""
  __slots__ = ['lane_num','lanes']
  _slot_types = ['int32','ys_ros_msgs/Lane[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.lane_num,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.lanes = []
      for i in range(0, length):
        val1 = ys_ros_msgs.msg.Lane()
        start = end
        end += 4
