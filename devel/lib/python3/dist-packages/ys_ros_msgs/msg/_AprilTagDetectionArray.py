...
"""autogenerated by genpy from ys_ros_msgs/AprilTagDetectionArray.msg. Do not edit."""
import codecs
import sys
...
class AprilTagDetectionArray(genpy.Message):
  _md5sum = "fb2dd94ea422b055d426ca1a0cba3b9c"
  _type = "ys_ros_msgs/AprilTagDetectionArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','ys_ros_msgs/AprilTagDetection[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.detections:
        ...
        if len(val1.corners) != 4:
          self._check_types(ValueError("Expecting %s items but found %s when writing '%s'" % (4, len(val1.corners), 'val1.corners')))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ys_ros_msgs.msg.AprilTagDetection()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.family = str[start:end].decode('utf-8', 'rosmsg')
        else:
