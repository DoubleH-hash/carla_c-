...
(cl:defclass <LaneDetectionArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector ys_ros_msgs-msg:LaneDetection)
   :initform (cl:make-array 0 :element-type 'ys_ros_msgs-msg:LaneDetection :initial-element (cl:make-instance 'ys_ros_msgs-msg:LaneDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LaneDetectionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaneDetectionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ys_ros_msgs-msg:<LaneDetectionArray> is deprecated: use ys_ros_msgs-msg:LaneDetectionArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LaneDetectionArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ys_ros_msgs-msg:LaneDetection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LaneDetectionArray>)))
  ...
  "ys_ros_msgs/LaneDetectionArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LaneDetectionArray)))
  "Returns string type for a message object of type 'LaneDetectionArray"
  "ys_ros_msgs/LaneDetectionArray")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LaneDetectionArray>)))
  ...
  "c93a62e7777b4d80f9bf607c90c25a61")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LaneDetectionArray)))
  "Returns md5sum for a message object of type 'LaneDetectionArray"
  "c93a62e7777b4d80f9bf607c90c25a61")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LaneDetectionArray>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%LaneDetection[] detections~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: ys_ros_msgs/LaneDetection~%int8 id     # lane number~%~%geometry_msgs/Point32[] points   # lane point list~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LaneDetectionArray)))
  "Returns full string definition for message of type 'LaneDetectionArray"
  (cl:format cl:nil "std_msgs/Header header~%LaneDetection[] detections~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: ys_ros_msgs/LaneDetection~%int8 id     # lane number~%~%geometry_msgs/Point32[] points   # lane point list~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%~%"))
